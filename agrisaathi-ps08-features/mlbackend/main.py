...
def bird_protection(data: BirdInput):
    ...
    try:
        ...
        return {
             "prevention_strategies": ["Use scarecrows or reflective ribbons.", "Deploy bio-acoustic bird repellents.", "Plant trap crops around the border."],
             "safe_practices": ["Avoid harmful chemical repellents.", "Cover the field with protective nets if feasible."],
             "action_suggestion": "Install bird netting and reflective tapes immediately.",
             "raw_response": res
        }
...
def animal_protection(data: AnimalInput):
    ...
    try:
        ...
        return {
             "prevention_strategies": ["Install solar-powered electric fencing or bio-fencing.", "Use traditional loud noises during night time.", "Plant thorny bushes as bio-fences."],
             "safe_practices": ["Do not use lethal traps or poisons.", "Coordinate with local forest department if protected wildlife is involved."],
             "action_suggestion": "Set up a community night watch and install motion-sensor alarms.",
             "raw_response": res
        }
